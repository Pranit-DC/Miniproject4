...
const ServicesSection: React.FC = () => {
      ...
      icon: (
        ...
        >
          <g clipPath="url(#clip0_2021_27)">
            <path
              d="M50.8787 14.5159L31.7839 27.8862C26.1779 23.871 18.4271 23.6068 12.4586 27.786C4.88928 33.0861 3.04511 43.5449 8.3452 51.1142C13.6453 58.6835 24.1041 60.5277 31.6734 55.2276C37.6419 51.0484 40.0446 43.6747 38.1889 37.0334L38.9893 36.473L46.7653 37.8441L48.1365 30.0681L55.9125 31.4392L58.5907 15.7956L50.8787 14.5159ZM26.8697 48.3672C23.0965 51.0092 17.8476 50.0837 15.2056 46.3105C12.5636 42.5373 13.4891 37.2884 17.2623 34.6464C21.0355 32.0044 26.2844 32.9299 28.9264 36.7031C31.5684 40.4763 30.6429 45.7252 26.8697 48.3672Z"
              fill="#54F4FC"
            ></path>
          </g>
          <defs>
  ...
  return (
    <section className="p-28 text-center" aria-labelledby="services-heading">
      <h2 id="services-heading" className="mb-12 text-4xl font-semibold">
        Services we offer
      </h2>
      <div className="grid gap-20 grid-cols-[repeat(2,1fr)] max-md:grid-cols-[1fr]">
